...
def redirects(level,Number):
    if request.method == 'POST':
        ...
        if option == answer_dict[level][Number]:
            if Number < 5:
                Number += 1
            elif Number == 5:
                level += 1
...
def answers(level, Number):
    ...
    question_dict = {
        ...
        3:{
            ...
            4:[
                'Rocket: “Whitey, do you know what IDE stands for?”'
            ],
            5:[
...
'Now you have to travel all the way to Brooklyn where an avenger A was born. This is the same avenger who was thought to be dead, but he/she isn\'t. Who’s the Avenger A?'
            ...
            2:['A lost love of his/her life to time. A finds a way to travel to the past to a place B where A and his/her lover were supposed to meet. What’s the name of the place B?'],
            3:['A has many friends but his/her best friend is a person C, who A used to work with but later they were both separated in a train incident and C was believed to be dead. Who’s C in the above context?'],
            4:['Later it was found that C is alive but lost something precious to life and got an artificially replaced by a powerful and dangerous organization D whose motto is, “If a head is cut off, two more shall take its place.”'],
            5:['This organization D was successful in getting their hands on a powerful weapon E from between a war, but was later acquired by a well-known group of people.'],
            6:['This weapon E was used to create a strong and powerful personality F.'],
            7:['Later F fell in love with G. G possesses abilities to alter reality in unspecified ways and is a powerful sorceress.'],
            8:['G has a brother H and most people know H by his superhero name. What’s the real name of H?'],
            9:['Both G and H are originally from a place I. Can you guess where I is?'],
            10:[
            ...
            11:['Strange thought his whole life was gone due to this accident because he wouldn’t be able to practice neurosurgeries after this.', 
            ...
            15:['Congrats for decoding, CAPTAIN! Now we have to find the code number which is so close to every MCU fan.', 
...
'(Take the approx. values)',
    ...
    return render_template('Part1/P1_Q1.html', points = points_dict[level][Number],Level = level ,stone=level-1,question=question_dict[level][Number])
