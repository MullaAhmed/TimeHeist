    ...
    question_dict = {
        ...
        5: {
            ...
            2: [
                ...
                "The shield is made of an alloy of steel and vibranium. The steel is to provide strength and rigidity so that when Captain America throws his mighty shield, it will ricochet, and the vibranium because it absorbs all vibrations, making it the perfect shock absorber, as seen in the scene where it absorbs Thor's hammer blow.",
                "Energy can't be destroyed. It can only be converted to another form. The energy of the hammer strike is converted into sound waves in the hammer, and if the vibranium absorbs it, it's converted into blue light, ultraviolet light, this enormous flash of light that's given off. It's showing that the vibranium is actually a perfect sonoluminescent material.",
            ...
            3: [
                "Dr. Strange hints Tony that this is the one possibility that he saw where they could win. Tony sees an opportunity in the confusion and transfers the stones to his nano gauntlet. So, Tony shows that he is trying to grab the gauntlet off of Thanos, but instead grabs all the stones and place them in his nano-tech gauntlet. “And I… am… Iron Man”. *Snaps*",
                ...
                "Dr. Strange knows that Tony Stark would die after he snaps. He still thinks about a way so that he can save Tony’s life. As every action has an equal opposite reaction, the consequences of using the power of the stones is that something is taken from the one who used them. Tony being a mortal was ready to use the stones to kill the whole army and face the consequence of losing all his lifespan and dying.",
                "So, Dr. Strange decides to seal Thanos in mirror dimension forever. For this Bruce comes forward and gets ready to bear the consequences of the same. Bruce then snaps his fingers to seal the mirror dimension forever which does not affect the reality much. Hence the consequences he receives is losing the power to ever become Hulk.",
